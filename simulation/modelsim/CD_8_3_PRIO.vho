...
-- X[0]	=>  Location: PIN_76,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- X[7]	=>  Location: PIN_91,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[6]	=>  Location: PIN_90,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[5]	=>  Location: PIN_89,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[4]	=>  Location: PIN_88,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[3]	=>  Location: PIN_83,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[2]	=>  Location: PIN_80,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[1]	=>  Location: PIN_77,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst3~0_combout\ = (\X[6]~input_o\) # ((\X[5]~input_o\) # ((\X[7]~input_o\) # (\X[4]~input_o\)))
...
-- Equation(s):
-- \inst4~0_combout\ = (!\X[5]~input_o\ & (!\X[4]~input_o\ & ((\X[3]~input_o\) # (\X[2]~input_o\))))
...
-- Equation(s):
-- \inst4~1_combout\ = (\W~input_o\ & ((\inst4~0_combout\) # ((\X[7]~input_o\) # (\X[6]~input_o\))))
...
-- Equation(s):
-- \inst5~2_combout\ = (\inst5~0_combout\) # ((!\X[6]~input_o\ & (\inst5~1_combout\ & \W~input_o\)))
